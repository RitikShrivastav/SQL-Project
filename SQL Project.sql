...
select sum(total) as total_amount, billing_city from invoice
...
select artist.artist_id, artist.name, count(artist.artist_id) as total_number_of_songs
from track
...
-- Q9: Write query to return the email, first name, last name, & Genre
